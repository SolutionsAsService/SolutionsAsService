- @SolutionsAsService, full stack engineer and CFO at shadw.
- knowledge regarding Workflow Automation, C/C++, Rust, Network Protocols, CSS, HTML, JS/TS/JSON, Arduino/ESP32, YAML (Ansible Playbooks), Node.js/NPM, React/Next.js, Docker, K8s, Hyperscaler Services/DevOps/Vercel, Redis, SQL/noSQL, Redis, COBOL, Python, blockchains, CAD design, Shell/Bash, Jupyter (Notebook), Bash/Shell, Make(file)/documentation, financial software, server assembly (+ more)
...
- currently learning RouterOS Script, iroh, Ruby (Rails), Tailwind, Jinja, PHP, Angular, Go, Perl, Lua, ASM/WASM etc.
