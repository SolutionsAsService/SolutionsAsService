...
- knowledge regarding Workflow Automation, C/C++, Network Protocols, JSON, CSS, HTML, JS/TS, Arduino/ESP32, YAML (Ansible Playbooks), Node.js/NPM, React/Next.js, Docker, Kubernetes, AWS/DevOps, Redis, SQL, Vercel, COBOL, Python, blockchains, CAD design, Shell/Bash, financial software (and more)
