...
- knowledge regarding Workflow Automation, C/C++, Rust, Network Protocols, CSS, HTML, JS/TS/JSON, Arduino/ESP32, YAML (Ansible Playbooks), Node.js/NPM, React/Next.js, Docker, K8s, Hyperscaler Services/DevOps/Vercel, Redis, SQL/noSQL, Redis, COBOL, Python, blockchains, CAD design, Shell/Bash, Jupyter (Notebook), Make(file)/documentation, financial software, server assembly (+ more)
