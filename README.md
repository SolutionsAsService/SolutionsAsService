...
- I have knowledge regarding Workflow Automation, C/C++, Network Protocols, JSON, CSS, HTML, JS/TS, Arduino/ESP32, YAML (Ansible Playbooks), Node.js, Next.js, Docker, Kubernetes, AWS/DevOps, Redis, SQL, Vercel, COBOL, blockchains, financial software (and more)
...
- 🌱 I’m currently learning React, hypercore, Rust, Python, Ruby (Rails), Tailwind, PHP, Angular, Go, Perl, Lua, Bash, ASM/WASM etc.
